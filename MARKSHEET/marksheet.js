        ...
        // Function to collect a required text value with **specific validation alert**
        function getValidatedText(promptMessage, fieldName) {
            var input;
            while (true) {
                ...
                // 🚨 Specific Alert based on fieldName
                alert("❌ Invalid input for **" + fieldName + "**.\n\nPlease enter valid text that contains letters.");
            }
        }

        // Function to collect a required numeric value with **specific validation alert**
        function getValidatedNumber(promptMessage, min, max, fieldName) {
            var input;
            var num;
            while (true) {
                input = prompt(promptMessage);
        ...
        function generateMarksheetFromPrompt() {
            ...
            // --- 1. Collect Personal Information with Specific Field Names in Validation ---

            // Roll Number (Numeric)
            var rollNum = getValidatedNumber("Enter Roll Number (e.g., 1001):", 1, 99999, "Roll Number");

            // Student Name (Text)
            var studentName = getValidatedText("Enter Student Name:", "Student Name");

            // Father Name (Text)
            var fatherName = getValidatedText("Enter Father Name:", "Father Name");
            ...
            while (validClasses.indexOf(className) === -1) {
                // 🚨 Specific Alert for Class
                alert("❌ Invalid input for **Class**.\n\nPlease enter a valid class: 9, 10, 11, or 12 only.");
                className = prompt(classInputPrompt);
                if (className === null) {
            ...
            var district = getValidatedText("Enter District Name:", "District Name");
            ...
            while (true) {
                ...
                // 🚨 Specific Alert for Date of Birth
                alert("❌ Invalid input for **Date of Birth**.\n\nPlease enter a date using numbers and separators (e.g., 15-08-2005).");
            }
            ...
            for (var i = 0; i < subjects.length; i++) {
                ...
                // Pass the specific subject name for the alert
                var marks = getValidatedNumber("Enter marks for " + subjectName + " (out of 100):", 0, 100, subjectName + " Marks");
            ...
            outputDiv.innerHTML =
                ...
                '<div class="table-responsive">' + // Added table-responsive for better mobile table viewing
